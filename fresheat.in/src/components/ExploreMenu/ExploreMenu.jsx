...
const ExploreMenu = ({ catagory,setCategory}) => {
  return (
<div className="container">
 <div className='explore-menu' id='explore-menu'>
    <h1>Explore our menu</h1>
    <p className='explore-menu-text'>We build innovative products & solutions that deliver unparalleled convenience to urban consumers.
